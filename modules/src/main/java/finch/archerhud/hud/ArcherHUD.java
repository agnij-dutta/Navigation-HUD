...
import finch.archerhud.app.MainActivity;
import finch.archerhud.app.R;
import finch.archerhud.eOutAngle;
import finch.archerhud.eOutType;
import finch.archerhud.eUnits;


public class ArcherHUD extends HUDAdapter {
    //===========================================================================================
    // 不與C++共用的部分
    //===========================================================================================
    private static final String TAG = ArcherHUD.class.getSimpleName();
    ...
    public ArcherHUD(Context context) {
        if (DEBUG) Log.d(TAG, "Creating ArcehrHUD instance");
        mContext = context;
