...
import finch.archerhud.ArrowV2;
...
//            int sad = getNotWhiteSAD(scaleImage, mArrowBitmaps[x]);
    ...
    private void updateHudInformation() {
        ...
        //===================================================================================
        // arrow
        // if same as last arrow, should be process, because archer Hud will erase the arrow without data receive during sometime..
        //===================================================================================
        if (mArrowTypeV2) {
